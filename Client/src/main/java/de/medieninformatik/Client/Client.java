...
public class Client extends Application {
    ...
    /**
     * Die zu verwendende Schrift, zusammengesetzt aus {@link #FONTSIZE} und der Schriftart
     */
    private final String FONT = " -fx-font: " + FONTSIZE + "pt \"Arial\";";

    /**
     * Die Hintergrundfarbe für den Anmelden-Button
     */
    private final String BG_GRAY = " -fx-background-color: \"lightgray\";";

    /**
     * Die Hintergrundfarbe für den Abmelden-Button
     */
     ...
     *
     * Falls eine LEAVE-Nachricht des Nutzers eintrifft, wird die Task und damit der Service beendet.
     */
